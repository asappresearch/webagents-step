...
- CLICK_CHECKBOXES "CONTEXT": Select checkbox(es) based on CONTEXT
- PROCESS_EMAIL "CONTEXT": Process any email task specified by CONTEXT
...
4. If the task requires you to select checkboxes, issue CLICK_CHECKBOXES "CONTEXT" where CONTEXT is the original context. 
...
5. If the task requires you to send emails or forward emails or reply to emails, issue PROCESS_EMAIL "CONTEXT" where  CONTEXT is the original context. Directly issue PROCESS_EMAIL. 
CONTEXT:
Give Bobine the email you received from Cora
REASONING:
The task requires me to give Bobine the email from Cora. Based on the instructions, I will issue PROCESS_EMAIL directly.
YOUR ACTION:
...
You are given:
1. CONTEXT: An instruction like CLICK_CHECKBOXES "QUERY", where "QUERY" defines the task.
2. CURRENT BROWSER CONTENT: A simplified text description of the current browser content, without formatting elements.
3. CURRENT URL: The current webpage URL.
4. PREVIOUS ACTIONS: A list of your past actions.
